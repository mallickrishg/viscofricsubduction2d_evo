function Yp=ode_fault_shearzones2d(~,Y,o,remoteloading)
...
% dgf = o.flt.dgf*o.flt.N + o.shz.dgf;
...
Yp(5:o.flt.dgf:o.flt.dgf*o.flt.N) = dsigdt;
...
Yp(4:o.flt.dgf:o.flt.dgf*o.flt.N) = (kv - o.flt.b.*sigma.*dth - (o.flt.mu0 + o.flt.a.*Y(4:o.flt.dgf:o.flt.dgf*o.flt.N) + o.flt.b.*th).*dsigdt)./(o.flt.a.*sigma + damping.*V);
