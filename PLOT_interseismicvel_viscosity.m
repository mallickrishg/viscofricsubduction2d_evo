...
% earthquake cycle simulation with spin-up
% AUTHOR:
...
faultparams = [];
faultparams.dip = 10;
faultparams.Tplate = 15e3;
faultparams.Vpl = 1e-9;

shzparams = [];
shzparams.eta_arc = 5e14;
shzparams.eta_oc = 1e13;% dummy value

% etavec = [5e12,1e13,3e13,5e13,7e13,1e14,3e14,5e14,1e15,5e15];
etavec = [1e13,5e13,1e14,1e15,1e20];
